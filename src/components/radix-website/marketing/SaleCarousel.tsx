                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg,  var(--crimson-5), var(--blue-5))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg,  var(--plum-3), var(--blue-3))",
                        },
                      }}>
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--blue-5), var(--lime-3))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--blue-3), var(--sand-6))",
                        },
                      }}>
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--lime-3), var(--pink-4))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--sand-6), var(--pink-3))",
                        },
                      }}>
                  ...
                  <GrabBox>
                    ...
                    <Text as="p" size="2" color="gray">
                      Supports keyboard and touch input, step interval, multiple
                      thumbs for value ranges, and RTL direction.
                    </Text>
                  </GrabBox>
                </CarouselSlide>
              </Box>
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--pink-4), var(--gold-5))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--pink-3), var(--gold-4))",
                        },
                      }}>
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--gold-5), var(--tomato-5))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--gold-4), var(--crimson-4))",
                        },
                      }}>
                      <PrimitivesHeroTabs />
                    </DemoContainer>
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--tomato-5), var(--indigo-7))",
                        ".dark &, .dark-theme &": {
                          background:
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--indigo-7), var(--cyan-3))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--indigo-5), var(--cyan-7))",
                        },
                      }}>
                  ...
                  <GrabBox>
                    ...
                    <Text as="p" size="2" color="gray">
                      With arrow key navigation, horizontal/vertical orientation
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--cyan-3), var(--mint-5))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--cyan-7), var(--teal-6))",
                        },
                      }}>
                  ...
                  <GrabBox>
                    ...
                    <Text as="p" size="2" color="gray">
                      ...
                      Supports single and multiple pressed buttons.
                    </Text>
                  </GrabBox>
                </CarouselSlide>
              </Box>
                ...
                <CarouselSlide>
                  <FocusArea
                    ...
                    <DemoContainer
                      ...
                      css={{
                        background:
                          "linear-gradient(120deg, var(--mint-5), var(--red-3))",
                        ".dark &, .dark-theme &": {
                          background:
                            "linear-gradient(120deg, var(--teal-6), var(--plum-4))",
                        },
                      }}>
